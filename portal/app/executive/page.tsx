...
export default function ExecutivePage() {
  return (
    <main className="min-h-screen bg-[#F4F7FC] px-4 pb-8 pt-[calc(env(safe-area-inset-top)+2rem)] text-slate-950 sm:px-6 sm:py-12">
      <div className="mx-auto mb-5 grid max-w-6xl grid-cols-2 gap-3 sm:flex sm:justify-end">
        ...
        <Link
          ...
          style={{ color: "#ffffff" }}
          className="col-span-2 inline-flex min-h-11 items-center justify-center gap-2 whitespace-nowrap rounded-full bg-[#123E74] px-5 text-sm font-bold text-white shadow-md sm:col-auto"
        >
