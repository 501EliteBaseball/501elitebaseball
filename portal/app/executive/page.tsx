  ...
  return (
    <main className="min-h-screen bg-[#F4F7FC] px-4 py-8 text-slate-950 sm:px-6 sm:py-12">
      <div className="mx-auto mb-5 grid max-w-6xl grid-cols-2 gap-3 sm:flex sm:justify-end">
        <Link href="/finance" style={{color:"#ffffff"}} className="inline-flex min-h-11 items-center justify-center gap-2 whitespace-nowrap rounded-full bg-emerald-700 px-4 text-sm font-bold text-white shadow-md sm:px-5"><WalletCards className="h-4 w-4"/>Finance OS</Link>
