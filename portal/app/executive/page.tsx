...
export default function ExecutivePage() {
  return (
    <main className="min-h-screen bg-[#F4F7FC] px-4 py-8 text-slate-950 sm:px-6 sm:py-12">
      <div className="mx-auto mb-5 flex max-w-6xl flex-wrap justify-end gap-3">
        <Link
          href="/executive/announcements"
          style={{ color: "#ffffff" }}
          className="inline-flex min-h-11 items-center gap-2 rounded-full bg-[#D7193F] px-5 text-sm font-bold text-white shadow-md"
        >
